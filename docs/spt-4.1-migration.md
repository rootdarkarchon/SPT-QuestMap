...
QuestMap 2.0 releases retain SPT 4.0.13 support. This tree has no dual-runtime implementation. All three production projects and the plugin use version 2.1.2.
